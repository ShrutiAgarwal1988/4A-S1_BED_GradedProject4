package com.greatlearning.springbootEmployeeManagementDesign.config;
...
import com.greatlearning.springbootEmployeeManagementDesign.serviceImpl.UserDetailsServiceImpl;
...
//	    protected void configure(HttpSecurity http) throws Exception {
//	        http.authorizeRequests()
//	            .antMatchers("/api","/api/employee").hasAnyAuthority("USER","ADMIN")
//	            .antMatchers("/employee/search/{FirstName}","").hasAuthority("ADMIN")
//	            .anyRequest().authenticated()
//	            .and()
//	            .formLogin().loginProcessingUrl("/login").permitAll().successForwardUrl("/api/employees").permitAll()
//	            .and()
//	            .logout().logoutSuccessUrl("/login").permitAll()
//	            .and()
//	            .exceptionHandling().accessDeniedPage("/api/employees/403")
//	            .and()
